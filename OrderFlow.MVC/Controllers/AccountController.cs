...
namespace OrderFlow.MVC.Controllers
{
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(LoginViewModel model)
        {
            ...
            user.LastLoginUtc = DateTime.UtcNow; _db.AuditEvents.Add(new AuditEvent { UserId = user.UserId, EntityType = "User", EntityId = user.UserId.ToString(), Action = AuditAction.Login, Detail = "Successful login." }); _db.SaveChanges();
